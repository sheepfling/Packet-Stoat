...
- Treat benchmark numbers in `docs/SAMPLE_BENCHMARK_REPORT.md` and `release_artifacts/benchmark_reports/` as development-environment samples, not hardware-independent promises.
