...
| Semantic observation rows | `128 / 141` | [Semantic PDU coverage](SEMANTIC_PDU_COVERAGE.md) |
| Semantic decoded Wave 2 rows | `9 / 141` | [Semantic PDU coverage](SEMANTIC_PDU_COVERAGE.md) |
| Fully domain-decoded rows | `13 / 141` | [Semantic PDU coverage](SEMANTIC_PDU_COVERAGE.md) |
...
instead of scattered one-off decoders. The current `13 / 141` fully
