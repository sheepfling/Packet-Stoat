...
def test_release_tag_from_python_version_handles_alpha_versions() -> None:
    assert release_metadata.release_tag_from_python_version("0.17.0a9") == "v0.17.0-alpha9"


def test_release_metadata_reads_current_project_version() -> None:
    assert release_metadata.project_version(ROOT) == "0.17.0a9"
    assert release_metadata.release_tag(ROOT) == "v0.17.0-alpha9"
