...
ARTIFACT_SPECS = (
    ...
    ("artifacts/reports/engine_benchmarks/native_engine_benchmark_report.json", "fastdis.engine_benchmark_report.v1"),
    ("artifacts/reports/engine_benchmarks/c_engine_benchmark_report.json", "fastdis.engine_benchmark_report.v1"),
    ("artifacts/reports/engine_benchmarks/cpp_engine_benchmark_report.json", "fastdis.engine_benchmark_report.v1"),
    ("artifacts/reports/engine_benchmarks/python_ctypes_engine_benchmark_report.json", "fastdis.engine_benchmark_report.v1"),
    ("artifacts/reports/engine_benchmarks/unreal_engine_benchmark_report.json", "fastdis.engine_benchmark_report.v1"),
    ("artifacts/reports/engine_benchmarks/unity_engine_benchmark_report.json", "fastdis.engine_benchmark_report.v1"),
    ("artifacts/reports/engine_benchmarks/godot_engine_benchmark_report.json", "fastdis.engine_benchmark_report.v1"),
    ("artifacts/reports/engine_head_to_head/unreal_vs_grill.json", "fastdis.engine_head_to_head_report.v1"),
    ("artifacts/reports/cross_engine_equivalence.json", "fastdis.cross_engine_equivalence_report.v1"),
    ("artifacts/reports/benchmark_matrix/benchmark_matrix.json", "fastdis.engine_benchmark_matrix.v1"),
    ("artifacts/reports/benchmark_coverage/benchmark_coverage_report.json", "fastdis.benchmark_coverage_report.v1"),
    ("artifacts/reports/scenario_contract/scenario_contract_report.json", "fastdis.scenario_contract_report.v1"),
    ("artifacts/reports/surface_claim_report/surface_claim_report.json", "fastdis.surface_claim_report.v1"),
    ("artifacts/reports/core_cross_platform_harness/core_cross_platform_harness_report.json", "fastdis.core_cross_platform_harness_report.v1"),
    ("artifacts/reports/benchmark_completion_audit/benchmark_completion_audit.json", "fastdis.engine_benchmark_completion_audit.v1"),
    ("artifacts/reports/benchmark_claim_summary/benchmark_claim_summary.json", "fastdis.benchmark_claim_summary.v1"),
    ("artifacts/reports/competitor_lane_summary/competitor_lane_summary.json", "fastdis.competitor_lane_summary.v1"),
    ("artifacts/reports/competitor_capture_manifest.json", "fastdis.competitor_capture_manifest.v1"),
    ("artifacts/reports/competitor_capture_validation.json", "fastdis.competitor_capture_validation.v1"),
)
