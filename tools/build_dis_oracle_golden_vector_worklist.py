#!/usr/bin/env python3
"""Build an actionable non-malformed golden-vector authoring queue."""
...
DEFAULT_OUT_DIR = ROOT / "artifacts" / "reports" / "dis_oracle_golden_vector_worklist"
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument("--json-out", type=Path, default=DEFAULT_OUT_DIR / "dis_oracle_golden_vector_worklist.json")
    parser.add_argument("--md-out", type=Path, default=DEFAULT_OUT_DIR / "dis_oracle_golden_vector_worklist.md")
...
def main(argv: list[str] | None = None) -> int:
    ...
    report = worklist_tool.build_report(
        ...
        only_vector_types={"minimal", "typical", "boundary", "stress_variable"},
    )
    ...
    write_json_report(
        ...
        producer="tools/build_dis_oracle_golden_vector_worklist.py",
    )
