...
def command_full(args: argparse.Namespace) -> int:
    ...
    hard_failure = doctor_code or build_code or bridge_code or demo_code or orientation_code or startup_probe_code or install_code or pre_signoff_report_code or report_code
    if hard_failure:
        return hard_failure
