...
def verify_packaged_plugin(plugin_dir: Path, package_dir: Path, target_platforms: list[str], mac_arches: str) -> None:
    ...
    common_required = [
        ...
        "Docs/FAB_DRAFT.md",
        "Docs/FIVE_MINUTE_SETUP.md",
        "Source/FastDisUnreal/FastDisUnreal.Build.cs",
        "Source/FastDisUnreal/Private/FastDisDemoController.cpp",
        "Source/FastDisUnreal/Private/FastDisGameManagerActor.cpp",
        "Source/FastDisUnreal/Private/FastDisReceiveFacadeComponent.cpp",
        "Source/FastDisUnreal/Private/FastDisEntityMappingDataAsset.cpp",
        "Source/FastDisUnreal/Private/FastDisEntityManagerComponent.cpp",
        "Source/FastDisUnreal/Private/FastDisGeoreferenceAdapterComponent.cpp",
        "Source/FastDisUnreal/Private/FastDisModule.cpp",
        "Source/FastDisUnreal/Private/FastDisPduDebugMarkerComponent.cpp",
        "Source/FastDisUnreal/Private/FastDisPduEvents.cpp",
        "Source/FastDisUnreal/Private/FastDisReplayActor.cpp",
        "Source/FastDisUnreal/Private/FastDisRuntimeMonitorComponent.cpp",
        "Source/FastDisUnreal/Private/FastDisRuntimeStatusWidget.cpp",
        "Source/FastDisUnreal/Private/FastDisSampleTrafficComponent.cpp",
        "Source/FastDisUnreal/Private/FastDisSendFacadeComponent.cpp",
        "Source/FastDisUnreal/Private/FastDisUdpReceiverComponent.cpp",
        "Source/FastDisUnreal/Private/FastDisUdpSenderComponent.cpp",
        "Source/FastDisUnreal/Private/FastDisWorldSubsystem.cpp",
        "Source/FastDisUnreal/Public/FastDisDemoController.h",
        "Source/FastDisUnreal/Public/FastDisEnumerationMappingAsset.h",
        "Source/FastDisUnreal/Public/FastDisEntityMappingDataAsset.h",
        "Source/FastDisUnreal/Public/FastDisGameManagerActor.h",
        "Source/FastDisUnreal/Public/FastDisEntityManagerComponent.h",
        "Source/FastDisUnreal/Public/FastDisGeoreferenceAdapterComponent.h",
        "Source/FastDisUnreal/Public/FastDisPduDebugMarkerComponent.h",
        "Source/FastDisUnreal/Public/FastDisPduEvents.h",
        "Source/FastDisUnreal/Public/FastDisReceiveFacadeComponent.h",
        "Source/FastDisUnreal/Public/FastDisReplayActor.h",
        "Source/FastDisUnreal/Public/FastDisRuntimeMonitorComponent.h",
        "Source/FastDisUnreal/Public/FastDisRuntimeStatusWidget.h",
        "Source/FastDisUnreal/Public/FastDisSampleTrafficComponent.h",
        "Source/FastDisUnreal/Public/FastDisSendFacadeComponent.h",
        "Source/FastDisUnreal/Public/FastDisTypes.h",
        "Source/FastDisUnreal/Public/FastDisUdpReceiverComponent.h",
        "Source/FastDisUnreal/Public/FastDisUdpSenderComponent.h",
