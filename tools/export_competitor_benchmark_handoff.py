...
def render_readme() -> str:
    return "\n".join(
        [
            ...
            "",
            "```bash",
            "python tools/normalize_grill_harness_capture.py --input verification_reports/unreal_grill_baseline/grill_unreal_benchmark_baseline.json",
            "python tools/normalize_grill_harness_capture.py --input verification_reports/unity_grill_baseline/grill_unity_benchmark_baseline.json",
            "```",
            "",
