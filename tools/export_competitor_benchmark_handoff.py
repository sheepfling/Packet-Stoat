...
DEFAULT_OUT_DIR = ROOT / "artifacts" / "dist" / "competitor_benchmark_handoff"
...
BASE_HANDOFF_FILES = (
    ...
    "tools/grill_harness_capture.py",
    ...
    "artifacts/verification_reports/unreal_grill_baseline/README.md",
    "artifacts/verification_reports/unreal_grill_baseline/grill_unreal_benchmark_baseline.template.json",
    "artifacts/verification_reports/unity_grill_baseline/README.md",
    "artifacts/verification_reports/unity_grill_baseline/grill_unity_benchmark_baseline.template.json",
    ...
    "artifacts/reports/engine_benchmarks/native_engine_benchmark_report.json",
    "artifacts/reports/engine_benchmarks/native_engine_benchmark_report.md",
    "artifacts/reports/engine_benchmarks/c_engine_benchmark_report.json",
    "artifacts/reports/engine_benchmarks/c_engine_benchmark_report.md",
    "artifacts/reports/engine_benchmarks/cpp_engine_benchmark_report.json",
    "artifacts/reports/engine_benchmarks/cpp_engine_benchmark_report.md",
    "artifacts/reports/engine_benchmarks/python_ctypes_engine_benchmark_report.json",
    "artifacts/reports/engine_benchmarks/python_ctypes_engine_benchmark_report.md",
    "artifacts/reports/engine_benchmarks/unreal_engine_benchmark_report.json",
    "artifacts/reports/engine_benchmarks/unreal_engine_benchmark_report.md",
    "artifacts/reports/engine_benchmarks/unity_engine_benchmark_report.json",
    "artifacts/reports/engine_benchmarks/unity_engine_benchmark_report.md",
    "artifacts/reports/engine_benchmarks/godot_engine_benchmark_report.json",
    "artifacts/reports/engine_benchmarks/godot_engine_benchmark_report.md",
    "artifacts/reports/network_ingest_matrix/network_ingest_matrix.json",
    "artifacts/reports/network_ingest_matrix/network_ingest_matrix.md",
    "artifacts/reports/cross_engine_equivalence.json",
    "artifacts/reports/cross_engine_equivalence.md",
...
def _refresh_default_args() -> argparse.Namespace:
    return argparse.Namespace(
        ...
        skip_core_filter_matrix=False,
        skip_core_filter_normalize=False,
        skip_core_replay_matrix=False,
        skip_core_replay_normalize=False,
        core_only=False,
        ...
        skip_core_cross_platform_harness=False,
...
def render_readme() -> str:
    return "\n".join(
        [
            ...
            "- shared GRILL harness capture validator and normalizer",
            ...
            "- cross-platform rerun runbook for junior operators",
            ...
            "",
            "```bash",
            "python tools/normalize_grill_harness_capture.py --input artifacts/verification_reports/unreal_grill_baseline/grill_unreal_benchmark_baseline.json",
            "python tools/normalize_grill_harness_capture.py --input artifacts/verification_reports/unity_grill_baseline/grill_unity_benchmark_baseline.json",
            "```",
            "",
            ...
            "```",
            "",
            "7. Preferred: rerun the shared refresh entrypoint once the GRILL",
            ...
            "```",
            "",
            "8. Or generate the side-by-side reports manually:",
            "",
            "```bash",
