...
def build_inner_script(config: dict[str, Any], *, archive_present: bool, extract_archive: bool) -> str:
    ...
    lines.extend(
        [
            ...
            f'mkdir -p "{local_repo}/tools" "{local_repo}/examples/unreal" "{local_repo}/src" "{local_repo}/include"',
            ...
            f'cp -R "/src/examples/unreal/FastDis" "{local_repo}/examples/unreal/FastDis"',
            f'cd "{local_repo}"',
