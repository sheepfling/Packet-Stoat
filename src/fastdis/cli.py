...
def command_doctor(_args: argparse.Namespace) -> int:
    ...
    print("  - fastdis-engine: fastdis-engine doctor|unity|godot|unreal")
    print("  - fastdis-lattice: fastdis-lattice doctor|discover|full|verify|showcase|sdk-check")
    print("  - packet-stoat meta: packet-stoat doctor|host|workspace|bootstrap")
    return 0
...
def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        prog="fastdis",
        description="FastDIS core CLI for DIS scanning, replay tooling, and product-owned bridge workflows.",
    )
