...
PDU_CATALOG: tuple[PduCatalogEntry, ...] = (
    ...
    PduCatalogEntry(7, 35, 7, "TransferOwnershipPdu", "Transfer Ownership", "Entity Management", False),
    ...
    PduCatalogEntry(7, 39, 8, "MinefieldDataPdu", "Minefield Data", "Minefield", False),
    PduCatalogEntry(7, 40, 8, "MinefieldResponseNackPdu", "Minefield Response Nack", "Minefield", False),
    PduCatalogEntry(7, 41, 9, "EnvironmentalProcessPdu", "Environmental Process", "Synthetic Environment", False),
    PduCatalogEntry(7, 42, 9, "GriddedDataPdu", "Gridded Data", "Synthetic Environment", False),
