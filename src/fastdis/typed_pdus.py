...
TYPED_PDU_DESCRIPTORS: tuple[TypedPduDescriptor, ...] = (
    ...
    TypedPduDescriptor(6, 46, 11, 'TSPI', 'TSPIPdu', 'Dis6TSPIPdu', 'Live Entity', 'SCHEMA_GAP', 'ENUM_ONLY', (), 'typed_envelope'),
    TypedPduDescriptor(6, 47, 11, 'Appearance', 'AppearancePdu', 'Dis6AppearancePdu', 'Live Entity', 'SCHEMA_GAP', 'ENUM_ONLY', (), 'typed_envelope'),
    TypedPduDescriptor(6, 48, 11, 'Articulated Parts', 'ArticulatedPartsPdu', 'Dis6ArticulatedPartsPdu', 'Live Entity', 'SCHEMA_GAP', 'ENUM_ONLY', (), 'typed_envelope'),
    TypedPduDescriptor(6, 49, 11, 'LE Fire', 'LEFirePdu', 'Dis6LEFirePdu', 'Live Entity', 'SCHEMA_GAP', 'ENUM_ONLY', (), 'typed_envelope'),
    TypedPduDescriptor(6, 50, 11, 'LE Detonation', 'LEDetonationPdu', 'Dis6LEDetonationPdu', 'Live Entity', 'SCHEMA_GAP', 'ENUM_ONLY', (), 'typed_envelope'),
    ...
    TypedPduDescriptor(6, 63, 10, 'Record-R', 'RecordReliablePdu', 'Dis6RecordReliablePdu', 'Simulation Management with Reliability', 'SCHEMA_GAP', 'ENUM_ONLY', (), 'typed_envelope'),
    ...
    TypedPduDescriptor(7, 8, 3, 'Resupply Cancel', 'ResupplyCancelPdu', 'Dis7ResupplyCancelPdu', 'Logistics', 'SCHEMA_GAP', 'ENUM_ONLY', (), 'typed_envelope'),
    ...
    TypedPduDescriptor(7, 28, 6, 'IFF', 'IffPdu', 'Dis7IffPdu', 'Distributed Emission Regeneration', 'SCHEMA_GAP', 'ENUM_ONLY', (), 'typed_envelope'),
    ...
    TypedPduDescriptor(7, 33, 7, 'Aggregate State', 'AggregateStatePdu', 'Dis7AggregateStatePdu', 'Entity Management', 'SCHEMA_GAP', 'ENUM_ONLY', (), 'typed_envelope'),
    TypedPduDescriptor(7, 34, 7, 'IsGroupOf', 'IsGroupOfPdu', 'Dis7IsGroupOfPdu', 'Entity Management', 'SCHEMA_GAP', 'ENUM_ONLY', (), 'typed_envelope'),
    TypedPduDescriptor(7, 35, 7, 'Transfer Ownership', 'TransferOwnershipPdu', 'Dis7TransferOwnershipPdu', 'Entity Management', 'SCHEMA_GAP', 'ENUM_ONLY', (), 'typed_envelope'),
    ...
    TypedPduDescriptor(7, 38, 8, 'Minefield Query', 'MinefieldQueryPdu', 'Dis7MinefieldQueryPdu', 'Minefield', 'SCHEMA_GAP', 'ENUM_ONLY', (), 'typed_envelope'),
    TypedPduDescriptor(7, 39, 8, 'Minefield Data', 'MinefieldDataPdu', 'Dis7MinefieldDataPdu', 'Minefield', 'SCHEMA_GAP', 'ENUM_ONLY', (), 'typed_envelope'),
    ...
    TypedPduDescriptor(7, 41, 9, 'Environmental Process', 'EnvironmentalProcessPdu', 'Dis7EnvironmentalProcessPdu', 'Synthetic Environment', 'SCHEMA_GAP', 'ENUM_ONLY', (), 'typed_envelope'),
    TypedPduDescriptor(7, 42, 9, 'Gridded Data', 'GriddedDataPdu', 'Dis7GriddedDataPdu', 'Synthetic Environment', 'SCHEMA_GAP', 'ENUM_ONLY', (), 'typed_envelope'),
    ...
    TypedPduDescriptor(7, 46, 11, 'TSPI', 'TSPIPdu', 'Dis7TSPIPdu', 'Live Entity', 'SCHEMA_GAP', 'ENUM_ONLY', (), 'typed_envelope'),
    TypedPduDescriptor(7, 47, 11, 'Appearance', 'AppearancePdu', 'Dis7AppearancePdu', 'Live Entity', 'SCHEMA_GAP', 'ENUM_ONLY', (), 'typed_envelope'),
    TypedPduDescriptor(7, 48, 11, 'Articulated Parts', 'ArticulatedPartsPdu', 'Dis7ArticulatedPartsPdu', 'Live Entity', 'SCHEMA_GAP', 'ENUM_ONLY', (), 'typed_envelope'),
    TypedPduDescriptor(7, 49, 11, 'LE Fire', 'LEFirePdu', 'Dis7LEFirePdu', 'Live Entity', 'SCHEMA_GAP', 'ENUM_ONLY', (), 'typed_envelope'),
    TypedPduDescriptor(7, 50, 11, 'LE Detonation', 'LEDetonationPdu', 'Dis7LEDetonationPdu', 'Live Entity', 'SCHEMA_GAP', 'ENUM_ONLY', (), 'typed_envelope'),
    ...
    TypedPduDescriptor(7, 63, 10, 'Record-R', 'RecordReliablePdu', 'Dis7RecordReliablePdu', 'Simulation Management with Reliability', 'SCHEMA_GAP', 'ENUM_ONLY', (), 'typed_envelope'),
    TypedPduDescriptor(7, 64, 10, 'Set Record-R', 'SetRecordReliablePdu', 'Dis7SetRecordReliablePdu', 'Simulation Management with Reliability', 'SCHEMA_GAP', 'ENUM_ONLY', (), 'typed_envelope'),
    ...
    TypedPduDescriptor(7, 67, 1, 'Entity State Update', 'EntityStateUpdatePdu', 'Dis7EntityStateUpdatePdu', 'Entity Information', 'PRESENT', 'CATALOGED', ('protocolVersion', 'exerciseID', 'pduType', 'protocolFamily', 'timestamp', 'length', 'pduStatus', 'padding', 'entityID', 'padding1', 'numberOfVariableParameters', 'entityLinearVelocity', 'entityLocation', 'entityOrientation', 'entityAppearance', 'variableParameters'), 'typed_structural'),
    ...
    TypedPduDescriptor(7, 70, 13, 'Information Operations Action', 'InformationOperationsActionPdu', 'Dis7InformationOperationsActionPdu', 'Information Operations', 'SCHEMA_GAP', 'ENUM_ONLY', (), 'typed_envelope'),
    TypedPduDescriptor(7, 71, 13, 'Information Operations Report', 'InformationOperationsReportPdu', 'Dis7InformationOperationsReportPdu', 'Information Operations', 'SCHEMA_GAP', 'ENUM_ONLY', (), 'typed_envelope'),
    TypedPduDescriptor(7, 72, 1, 'Attribute', 'AttributePdu', 'Dis7AttributePdu', 'Entity Information', 'PRESENT_BUT_MISSING_PDU_TYPE_INITIAL_VALUE', 'ENUM_ONLY', (), 'typed_envelope'),
)
