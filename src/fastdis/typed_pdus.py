...
TYPED_PDU_DESCRIPTORS: tuple[TypedPduDescriptor, ...] = (
    TypedPduDescriptor(6, 0, 0, 'Other', 'OtherPdu', 'Dis6OtherPdu', 'Protocol Family 0', 'PRESENT', 'CATALOGED', ('opaquePayload',), 'typed_structural'),
    ...
    TypedPduDescriptor(7, 0, 0, 'Other', 'OtherPdu', 'Dis7OtherPdu', 'Protocol Family 0', 'PRESENT', 'CATALOGED', ('opaquePayload',), 'typed_structural'),
